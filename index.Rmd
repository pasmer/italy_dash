...
output$vbox5 <- renderValueBox({
  valueBox(value = paste(format((italy_total_new() %>% dplyr::filter(date == max(date)))$total_tests, big.mark = ","), sep = ""),
...
output$vbox6 <- renderValueBox({
  valueBox(value = paste(format((italy_total_new() %>% dplyr::filter(date == max(date)))$intensive_care, big.mark = ","), sep = ""),
